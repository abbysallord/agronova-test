...
"[project]/agronova/app/api/community/posts/comment/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const newComment = __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbPosts"].addComment(postId, {
            userEmail,
            userName,
            text
        }); // id date auto added
        if (!newComment) return __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Post not found"
        }, {
            status: 404
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newComment);
    } catch (e) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: e.message
        }, {
...
async function DELETE(req) {
    try {
        ...
        const result = __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbPosts"].deleteComment(postId, commentId, userEmail);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__61388f65._.js.map