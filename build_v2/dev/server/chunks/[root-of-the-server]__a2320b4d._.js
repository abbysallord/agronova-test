...
"[project]/agronova/app/api/store/order/create/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        for (const [vpa, group] of entries){
            ...
            // Create Order in DB
            const newOrder = await __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbOrders"].create({
            ...
            await transporter.sendMail({
                ...
                html: __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$lib$2f$email$2d$templates$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EmailTemplate"].Invoice(newOrder.id, newOrder.amount, newOrder.items) // Assuming EmailTemplate.Invoice takes (id, amount, items)
            });
            ...
            await transporter.sendMail({
                ...
                html: __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$lib$2f$email$2d$templates$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EmailTemplate"].SellerVerification(newOrder.id, newOrder.amount, newOrder.buyerUpiIndex || "", verifyLink) // Assuming EmailTemplate.SellerVerification takes (id, amount, buyerUpiIndex, verifyLink)
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a2320b4d._.js.map