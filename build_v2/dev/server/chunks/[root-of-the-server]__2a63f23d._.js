...
"[project]/agronova/app/api/community/posts/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(req, props) {
    try {
        ...
        const success = __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbPosts"].delete(id, userEmail);
        if (!success) {
            // Keep debug info if possible
            const posts = __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbPosts"].getAll();
            ...
            if (!post) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: `Not Found. ID: ${id}, Total Posts: ${posts.length}`
                }, {
                    status: 403
                });
            }
            ...
            if (owner !== safeEmail) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: `Unauthorized. Owner: ${owner}, You: ${safeEmail}`
                }, {
                    status: 403
                });
            }
            return __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Delete Failed in DB Helper"
            }, {
                status: 403
            });
        }
...
async function PATCH(req, props) {
    try {
        ...
        const updated = __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbPosts"].edit(id, userEmail, content);
        if (!updated) {
            const posts = __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbPosts"].getAll();
            const post = posts.find((p)=>p.id === id);
            if (!post) return __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Edit: Post Not Found (${id})`
            }, {
                status: 403
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Edit Unauthorized. Owner: ${post.userEmail}, You: ${userEmail}`
            }, {
                status: 403
            });
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updated);
    } catch (e) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$agronova$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: e.message
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2a63f23d._.js.map